...
namespace Cardence.Infrastructure.Migrations
{
    ...
    [Migration("20260714203814_ReplaceSavedCardsWithUserSavedCardIds")]
    partial class ReplaceSavedCardsWithUserSavedCardIds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cardence.Domain.Entities.Card", b =>
                {
                    ...
                    b.Property<bool>("IsWalletContact")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_wallet_contact");
                    ...
                    b.HasIndex("UserId", "IsWalletContact");
            ...
            modelBuilder.Entity("Cardence.Domain.Entities.EventGroupWalletCard", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "CardId", "EventGroupId");

                    b.HasIndex("EventGroupId");

                    b.HasIndex("UserId", "CardId");

                    b.ToTable("event_group_wallet_cards", (string)null);
                });
            ...
            modelBuilder.Entity("Cardence.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("SavedCardIds")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("saved_card_ids");

                    b.Property<string>("SavedCardNotes")
                        .IsRequired()
                        .HasColumnType("jsonb")
