...
class AddManualCardStepProfessional extends StatefulWidget {
  const AddManualCardStepProfessional({
    super.key,
    required this.draft,
  ...
  @override
  State<AddManualCardStepProfessional> createState() =>
      _AddManualCardStepProfessionalState();
}

class _AddManualCardStepProfessionalState
    extends State<AddManualCardStepProfessional> {
  ...
  @override
  void didUpdateWidget(AddManualCardStepProfessional oldWidget) {
  ...
  Widget build(BuildContext context) {
    return OnboardingStepShell(
      subtitle: context.l10n.kartvizitinnYzndeGrnecekBilgiler,
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            hintText: context.l10n.pozisyonuGiriniz,
          ...
          Center(
            child: OnboardingCardPreviewFrame(
              draft: ManualSavedCardPreviewHelper.toPreviewDraft(widget.draft),
            ),
          ),
        ],
      ),
