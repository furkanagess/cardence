...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get hataBildirimi => 'Bug report';

  @override
  String get henzEtkinlikGrubuYok => 'No event groups yet';
  ...
  String get soyadYalnzcaHarfIermeliEn =>
      'Last name must contain only letters (at least 2 characters)';

  @override
  String get soyadZorunludur => 'Last name is required';
  ...
  @override
  String get sessionNotFoundLogin => 'Session not found. Please sign in again.';
  ...
  @override
  String get sessionInfoUnavailable => 'Could not retrieve session info.';

  @override
  String get invalidSessionResponse => 'Invalid session response.';

  @override
  String get profileInfoUnavailable => 'Could not retrieve profile info.';
  ...
  @override
  String get serverResponseUnreadable => 'Could not read server response.';

  @override
  String get cardIdMissing => 'Card ID is missing.';

  @override
  String get eventGroupsLoadFailed => 'Could not load event groups.';

  @override
  String get eventGroupLoadFailed => 'Could not load event group.';

  @override
  String get eventGroupCreateFailed => 'Could not create event group.';

  @override
  String get eventPhotoUploadFailed => 'Could not upload event photo.';

  @override
  String get eventGroupDeleteFailed => 'Could not delete event group.';

  @override
  String get cardsLinkToGroupFailed => 'Could not add cards to group.';

  @override
  String get cardRemoveFromGroupFailed => 'Could not remove card from group.';

  @override
  String get supportRequestFailed => 'Could not send support request.';

  @override
  String get walletQuotaLoadFailed => 'Could not load wallet quota.';

  @override
  String get cardAddToWalletFailed => 'Could not add card to wallet.';

  @override
  String get cardInfoLoadFailed => 'Could not load card info.';

  @override
  String get invalidCardId => 'Invalid card ID.';

  @override
  String get invalidCardResponse => 'Invalid card response.';
  ...
  @override
  String get balang => 'Getting started';

  @override
  String get kimlik => 'Identity';

  @override
  String get iBilgileri => 'Work info';

  @override
  String get letiim => 'Contact';

  @override
  String get adnz => 'Your name';

  @override
  String get profilFotoraf => 'Profile photo';

  @override
  String get kartNizlemesi => 'Card preview';

  @override
  String get nvlan => 'Title';

  @override
  String get henzBilgiYok => 'No information yet';

  @override
  String get onboardingCardListedHere =>
      'Cards you create during onboarding will appear here.';

  @override
  String get changesReflectInPreview =>
      'Changes reflect in the preview instantly; tap Save to persist.';
  ...
  String get scanQrToSaveCard =>
      'Others can scan this QR with Cardence to save your card.';
  ...
  @override
  String get noCardsInGroup => 'No cards in this group';
  ...
  @override
  String get kartYzundeGosterilecekAlanlar => 'Fields shown on card front';

  @override
  String enFazlaAlanSecin(int count, int max) {
    return 'Select up to $max fields';
  }

  @override
  String cardsShowing(int shown, int total) {
    return '$shown / $total cards shown';
  }
  ...
  String get cardenceIleDijitalKartvizitlerinizi =>
      'With Cardence you can create, share, and manage your digital business cards in one wallet.';

  @override
  String get uygulamaSrme => 'App version:';

  @override
  String get sagAlttakiEkleIleQr =>
      'Use Add at the bottom right to scan a QR code or enter a card ID';
  ...
  String get privacySection1Body =>
      'When you create an account we collect your name, email, and optional phone number. Your business card details and technical usage data are processed to provide the service.';

  @override
  String get privacySection2Title => '2. How we use data';

  @override
  String get privacySection2Body =>
      'We use your data to manage your account, share your cards, maintain security, and improve the service. Marketing messages are sent only with your explicit consent.';
  ...
  String get privacySection3Body =>
      'We do not sell your personal data. Limited sharing may occur for legal obligations, service providers (hosting, analytics), or with your explicit consent.';
  ...
  String get privacySection4Body =>
      'We retain your data while your account is active. When you delete your account, data is deleted or anonymized within a reasonable period except where law requires retention.';
  ...
  String get privacySection5Body =>
      'You may request access, correction, deletion, or restriction of processing. Contact us through the in-app Support section.';
  ...
  String get privacySection6Body =>
      'We use encryption, access controls, and regular security reviews. No system is 100% secure; we recommend using a strong password.';
  ...
  String get privacySection7Body =>
      'We may update this policy from time to time. Material changes will be announced in the app. Continued use after an update means you accept the revised policy.';

  @override
  String get termsOfUseTitle => 'Terms of Use';

  @override
  String get termsSection1Title => '1. Scope of service';

  @override
  String get termsSection1Body =>
      'Cardence provides digital business card creation, sharing, and management. By using the app you agree to these terms.';
  ...
  String get termsSection2Body =>
      'You are responsible for providing accurate, up-to-date registration information. Do not share your password with others.';

  @override
  String get termsSection3Title => '3. Acceptable use';

  @override
  String get termsSection3Body =>
      'You may not use the service unlawfully, deceptively, or in ways that infringe others\' rights. You are solely responsible for your card content.';
  ...
  String get termsSection4Body =>
      'The Cardence brand, interface, and software belong to Cardence. You own your card content and grant us a limited license to operate the service.';

  @override
  String get termsSection5Title => '5. Service changes';

  @override
  String get termsSection5Body =>
      'We may change the service to improve features or meet legal obligations. Material updates may be communicated in-app or by email.';
  ...
  String get termsSection6Body =>
      'The service is provided \"as is\". We exercise reasonable care but do not guarantee uninterrupted or error-free operation. To the extent permitted by law we are not liable for indirect damages.';
